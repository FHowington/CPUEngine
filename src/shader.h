...
enum class shaderType { FlatShader, GouraudShader, InterpFlatShader, InterpGouraudShader, PlaneXZShader, PlaneXYShader, PlaneYZShader };
...
class GouraudShader : public TexturedShader, public InFrontCamera {
 public:
...
class InterpGouraudShader : public UntexturedShader, public InFrontCamera {
 public:
