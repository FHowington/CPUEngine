...
const fMatrix<4,4> viewport(const int x, const int y, const int w, const int h) {
...
fMatrix<4,4> getProjection(float focalLength) {
  fMatrix m = fMatrix<4,4>::identity();
