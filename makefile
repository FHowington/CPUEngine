engine: main.o tgaimage.o loader.o RasterizePolygon.o geometry.o
	clang++ -o engine main.o tgaimage.o loader.o RasterizePolygon.o geometry.o -lstdc++ -std=c++17 -lSDL2 -g -mavx2 -Ofast -Rpass-analysis=loop-vectorize -Rpass=loop-vectorize

main.o: main.cpp RasterizePolygon.o loader.o Window.h
	clang++ -c main.cpp -std=c++17 -g  -mavx2 -Ofast -Rpass-analysis=loop-vectorize -Rpass=loop-vectorize
